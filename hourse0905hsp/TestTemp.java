	...
	public static void sort(ArrayList<Point> ps) { // 进行递增排序
		ps.sort(new Comparator<Point>() {
			...
			public int compare(Point o1, Point o2) {
				// 先写出原生态的, 再优化
				/*
				 * //获取到o1的下一步的所有位置个数 int count1 = next(o1).size(); //获取到o2的下一步的所有位置个数 int
				 * count2 = next(o2).size(); if(count1 < count2) { return -1; } else if (count1
				 * == count2) { return 0; } else { return 1; }
				 */
