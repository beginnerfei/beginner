...
import com.hsp.qqsever.qqcommon0695hsp.Message;
import com.hsp.qqsever.qqcommon0695hsp.MessageType;
import com.hsp.qqsever.qqcommon0695hsp.User;
    ...
    public QQServer() {
        ...
        try {
            ...
            while (true) { //当和某个客户端连接后，会继续监听, 因此while
                ...
                Message message = new Message();  //创建一个Message对象，准备回复客户端
            ...
            //如果服务器退出了while，说明服务器端不在监听，关闭ServerSocket
            try {
                ss.close();
            } catch (IOException e) {
                e.printStackTrace();
