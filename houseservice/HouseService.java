package com.hsp.houseservice;

import com.hsp.housedomain.House;

/**
 * HouseService.java<=>类 [业务层] //定义House[] ,保存House对象 1. 响应HouseView的调用 2.
 * 完成对房屋信息的各种操作(增删改查c[create]r[read]u[update]d[delete])
 */
public class HouseService {
	...
	public boolean add(House newHouse) {
		// 判断是否还可以继续添加(暂时不考虑数组扩容的问题) => 能否自己加入数组扩容机制
